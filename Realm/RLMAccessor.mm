...
static inline RLMObjectBase *RLMGetLink(__unsafe_unretained RLMObjectBase *const obj, NSUInteger colIndex) {
    ...
    return RLMCreateObjectAccessor(obj->_realm, obj->_realm->_info[obj->_info->propertyForTableColumn(colIndex).objectClassName], index);
}
    ...
    switch (accessorCode) {
        case RLMAccessorCodeByte:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return (char)RLMGetLong(obj, index);
            });
        case RLMAccessorCodeShort:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return (short)RLMGetLong(obj, index);
            });
        case RLMAccessorCodeInt:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return (int)RLMGetLong(obj, index);
            });
        case RLMAccessorCodeLongLong:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetLong(obj, index);
            });
        case RLMAccessorCodeLong:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return (long)RLMGetLong(obj, index);
            });
        case RLMAccessorCodeFloat:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetFloat(obj, index);
            });
        case RLMAccessorCodeDouble:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetDouble(obj, index);
            });
        case RLMAccessorCodeBool:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetBool(obj, index);
            });
        ...
        case RLMAccessorCodeIntObject:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetIntObject(obj, index);
            });
        case RLMAccessorCodeFloatObject:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetFloatObject(obj, index);
            });
        case RLMAccessorCodeDoubleObject:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetDoubleObject(obj, index);
            });
        case RLMAccessorCodeBoolObject:
            return imp_implementationWithBlock(^(__unsafe_unretained RLMObjectBase *const obj) {
                return RLMGetBoolObject(obj, index);
            });
...
id RLMDynamicGet(__unsafe_unretained RLMObjectBase *const obj, __unsafe_unretained RLMProperty *const prop) {
    ...
    switch (accessorCodeForType(prop.objcType, prop.type)) {
        case RLMAccessorCodeByte:         return @((char)RLMGetLong(obj, index));
        case RLMAccessorCodeShort:        return @((short)RLMGetLong(obj, index));
        case RLMAccessorCodeInt:          return @((int)RLMGetLong(obj, index));
        case RLMAccessorCodeLong:         return @((long)RLMGetLong(obj, index));
        case RLMAccessorCodeLongLong:     return @(RLMGetLong(obj, index));
        case RLMAccessorCodeFloat:        return @(RLMGetFloat(obj, index));
        case RLMAccessorCodeDouble:       return @(RLMGetDouble(obj, index));
        case RLMAccessorCodeBool:         return @(RLMGetBool(obj, index));
        ...
        case RLMAccessorCodeIntObject:    return RLMGetIntObject(obj, index);
        case RLMAccessorCodeFloatObject:  return RLMGetFloatObject(obj, index);
        case RLMAccessorCodeDoubleObject: return RLMGetDoubleObject(obj, index);
        case RLMAccessorCodeBoolObject:   return RLMGetBoolObject(obj, index);
